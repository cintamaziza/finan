                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-[var(--color-border)] rounded-lg hover:bg-white transition-colors">
                                ...
                                <span className="font-medium text-[var(--color-text)]">Google</span>
                            </button>
                            <button className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-[var(--color-border)] rounded-lg hover:bg-white transition-colors">
            ...
            <div className="hidden lg:flex flex-1 gradient-hero items-center justify-center p-12 relative overflow-hidden">
                ...
                <div className="text-white text-center relative z-10 max-w-md">
                    ...
                    <p className="text-white/80 text-lg">
                        Track spending, set budgets, and achieve your financial goals all in one place.
                    </p>
